...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_simple_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/john/moveit/install/${idir}'.  Ask the maintainer 'Michael Ferguson <fergs@unboundedrobotics.com>' to fix it.")
    endif()
